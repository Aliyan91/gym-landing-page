...
<Sectionwrapper>
  ...
  >
    ...
    <p
      class="text-xl sn:text-3xl md:text-3xl text-center max-w-[1000px] mx-auto w-full"
    >
      Less thinking ad more doing. We're the tariner in your pocket full of <span
        class="italic"
        >personalized workouts, exercise explanantions, analytics</span
      > and much more
    </p>
    <Stars></Stars>
    <CtAs></CtAs>
